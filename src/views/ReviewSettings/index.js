...
@connect(
  state => ({
    ...
    bsnList: state.pages.reviewSettings.bsnList,
    bsnListTotalNum: state.pages.reviewSettings.bsnListTotalNum,
    bsnSelectOpt: state.pages.reviewSettings.bsnSelectOpt
  }),
