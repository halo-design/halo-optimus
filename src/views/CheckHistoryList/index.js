...
@connect(
  state => {
    const { pages: { checkHistoryList } } = state
    return {
      historyList: checkHistoryList.historyList,
      historyListSelectOpt: checkHistoryList.historyListSelectOpt,
      totalNum: checkHistoryList.historyListTotalNum
    }
  },
