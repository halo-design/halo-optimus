...
const API = {
  ...
  WHITELIST_ADD_INFO_URL: `${RMU}IM10003.do`,

  // 资源配置管理
  GET_RESOURCE_URL: `${RMU}IM10006.do`,
  ADD_RESOURCE_URL: `${RMU}IM10005.do`,
  DEL_RESOURCE_URL: `${RMU}IM10008.do`,
  CHANGE_RESOURCE_URL: `${RMU}IM10007.do`,

  // 热修复管理
  GET_HOTPATCHLIST_URL: `${RMU}IM10017.do`,
  ADD_HOTPATCHLIST_URL: `${RMU}IM10016.do`,
  QUERY_HOTPATCHLIST_URL: `${RMU}IM10019.do`,
  ADD_HOTPATCHTASK_URL: `${RMU}IM10018.do`,
  PAUSE_HOTPATCHTASK_URL: `${RMU}IM10015.do`,

  // 发布管理
  GET_UPDATELIST_URL: `${RMU}IM10010.do`,
  ADD_UPGRADELISHT_URL: `${RMU}IM10009.do`,
  ADD_UPGRADETASK_URL: `${RMU}IM10012.do`,
  GET_UPGRADETASK_URL: `${RMU}IM10013.do`,
  GET_TASK_DETAIL_URL: `${RMU}IM10014.do`,
  CHANGE_TASK_STATUS_URL: `${RMU}IM10015.do`
